...
export default function ComingSoon() {
  return (
    <section id="coming-soon" className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="w-full max-w-sm h-80 sm:h-96 bg-gradient-to-br from-blue-200 to-teal-200 rounded-2xl overflow-hidden">
            <img
