export default function About() {
  return (
    <section id="about" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-start">
            <div className="w-full max-w-sm h-96 bg-gradient-to-br from-gray-300 to-gray-400 rounded-xl overflow-hidden">
              <img
